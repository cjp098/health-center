...
export default function UpdatePatient({ location }) {
    ...
    const onSubmit = async (event) => {
        ...
        await httpRequest.post("/.netlify/functions/patients?name=updatePatient", config).then((response) => {
            swal.fire({
                icon: "success",
                title: "YAY!",
                text: response.data
